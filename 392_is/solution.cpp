...
/* * Решение
 * Сначала проверка на пограничные случаи: пустая строка всегда подстрока любой строки(даже пустой),
 ...
 * Далее имеем итераторы(указатели) i,j на строки, i - на потенциальную подстроку, j - на строку, в которой ищем
